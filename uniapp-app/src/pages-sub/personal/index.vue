  ...
  <view class="profile-edit-page h-full flex flex-col bg-gray-50">
    <view class="header-section relative">
      <view class="relative h-40 overflow-hidden bg-primary-400">
        <view class="absolute h-32 w-32 rounded-full bg-white opacity-10 -right-8 -top-8" />
        <view class="absolute bottom-4 right-16 h-16 w-16 rounded-full bg-white opacity-10" />
      </view>
      ...
      <view class="absolute bottom-0 left-1/2 translate-y-1/2 transform -translate-x-1/2">
        <view class="relative">
          <view class="h-24 w-24 overflow-hidden border-4 border-white rounded-full shadow-lg" @click="changeAvatar">
            <image v-if="userInfo.avatar" :src="userInfo.avatar" class="size-full" mode="aspectFill" />

            <image v-else src="@/static/vite.png" class="size-full" mode="aspectFill" />
          </view>
          <view
          ...
          >
            <view class="i-carbon-edit text-sm text-white" />
          </view>
        </view>
      </view>
    </view>
    ...
    <view class="content-section flex-1 px-4 pb-4 pt-16">
      <view class="info-card mb-4 overflow-hidden rounded-xl bg-white shadow-sm">
        <view class="card-header">
          <view class="i-carbon-user text-lg text-primary-500" />
        ...
        <view class="divide-y divide-gray-100">
          <view class="info-item" @click="editField('username')">
            <view class="info-label">
              <view class="i-carbon-user-identification text-lg text-gray-400" />
              <text>用户名</text>
            </view>
          ...
          <view class="info-item" @click="editField('realName')">
            <view class="info-label">
              <view class="i-carbon-identification text-lg text-gray-400" />
              <text>真实姓名</text>
            </view>
            <view class="info-value">
          ...
          <view class="info-item" @click="editField('gender')">
            <view class="info-label">
              <view class="i-carbon-gender-male text-lg text-gray-400" />
              <text>性别</text>
            </view>
            <view class="info-value">
          ...
          <view class="info-item" @click="editField('birthday')">
            <view class="info-label">
              <view class="i-carbon-calendar text-lg text-gray-400" />
              <text>生日</text>
            </view>
            <view class="info-value">
      ...
      <view class="info-card mb-4 overflow-hidden rounded-xl bg-white shadow-sm">
        <view class="card-header">
          <view class="i-carbon-phone text-lg text-primary-500" />
          <view class="card-title">
            联系方式
          </view>
        </view>
        ...
        <view class="divide-y divide-gray-100">
          <view class="info-item" @click="editField('phone')">
            <view class="info-label">
              <view class="i-carbon-mobile text-lg text-gray-400" />
              <text>手机号</text>
            </view>
            <view class="info-value">
          ...
          <view class="info-item" @click="editField('email')">
            <view class="info-label">
              <view class="i-carbon-email text-lg text-gray-400" />
              <text>邮箱地址</text>
            </view>
            <view class="info-value">
          ...
          <view class="info-item" @click="editField('wechat')">
            <view class="info-label">
              <view class="i-carbon-logo-wechat text-lg text-gray-400" />
              <text>微信号</text>
            </view>
            <view class="info-value">
      ...
      <view class="info-card mb-4 overflow-hidden rounded-xl bg-white shadow-sm">
        <view class="card-header">
          <view class="i-carbon-location text-lg text-primary-500" />
          <view class="card-title">
            地址信息
          </view>
        </view>
        ...
        <view class="divide-y divide-gray-100">
          <view class="info-item" @click="editField('region')">
            <view class="info-label">
              <view class="i-carbon-earth text-lg text-gray-400" />
              <text>所在地区</text>
            </view>
            <view class="info-value">
          ...
          <view class="info-item" @click="editField('address')">
            <view class="info-label">
              <view class="i-carbon-map text-lg text-gray-400" />
              <text>详细地址</text>
            </view>
            <view class="info-value">
      ...
      <view class="info-card mb-4 overflow-hidden rounded-xl bg-white shadow-sm">
        <view class="card-header">
          <view class="i-carbon-settings text-lg text-primary-500" />
          <view class="card-title">
            账户设置
          </view>
        </view>
        ...
        <view class="divide-y divide-gray-100">
          ...
          <view class="info-item" @click="privacySettings">
            <view class="info-label">
              <view class="i-carbon-security text-lg text-gray-400" />
              <text>隐私设置</text>
            </view>
            <view class="info-value">
              <text class="text-gray-400">
          ...
          <view class="info-item" @click="deleteAccount">
            <view class="info-label">
              <view class="i-carbon-user-x text-lg text-red-400" />
    ...
    <view class="action-section px-4 pb-8 pt-4">
      <button
        ...
        hover-class="bg-primary-600" @click="saveProfile"
      >
        <view class="i-carbon-save mr-2 text-lg" />
        保存修改
      </button>
    </view>
  </view>
