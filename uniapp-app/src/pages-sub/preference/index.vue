  ...
  <view class="p-4 bg-[#f9fafb]">
    ...
    <view class="settings-card">
      <view class="card-header">
        <view class="i-carbon-paint-brush text-lg text-primary-500" />
      ...
      <view class="divide-y divide-gray-100">
        <view class="setting-item">
          <view class="setting-label">
            <view class="i-carbon-moon text-lg text-gray-400" />
          ...
          <view class="setting-control">
            <switch :checked="settings.darkMode" :color="currentThemeColor" @change="toggleSetting('darkMode')" />
          </view>
        </view>

        <view class="setting-item" @click="selectThemeColor">
          <view class="setting-label">
            <view class="i-carbon-color-palette text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                主题色彩
              </text>
          ...
          <view class="setting-control">
            <view
              class="h-6 w-6 border-2 border-gray-200 rounded-full"
              :style="{ backgroundColor: currentThemeColor }"
            />
            <view class="i-carbon-chevron-right ml-2 text-sm text-gray-400" />
          </view>
        </view>

        <view class="setting-item" @click="adjustFontSize">
          <view class="setting-label">
            <view class="i-carbon-text-font text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                字体大小
              </text>
          ...
          <view class="setting-control">
            <view class="i-carbon-chevron-right text-sm text-gray-400" />
          </view>
        </view>
      </view>
    </view>
    ...
    <view class="settings-card">
      <view class="card-header">
        <view class="i-carbon-notification text-lg text-primary-500" />
        <view class="card-title">
          通知设置
        </view>
      </view>
      ...
      <view class="divide-y divide-gray-100">
        <view class="setting-item">
          <view class="setting-label">
            <view class="i-carbon-notification-new text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                推送通知
              </text>
          ...
          <view class="setting-control">
            <switch
              :checked="settings.pushNotification" :color="currentThemeColor"
        ...
        <view class="setting-item">
          <view class="setting-label">
            <view class="i-carbon-volume-up text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                声音提醒
              </text>
          ...
          <view class="setting-control">
            <switch :checked="settings.soundAlert" :color="currentThemeColor" @change="toggleSetting('soundAlert')" />
          </view>
        </view>

        <view class="setting-item">
          <view class="setting-label">
            <view class="i-carbon-phone-vibrate text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                震动反馈
              </text>
          ...
          <view class="setting-control">
            <switch :checked="settings.vibration" :color="currentThemeColor" @change="toggleSetting('vibration')" />
          </view>
        </view>
      </view>
    </view>
    ...
    <view class="settings-card">
      <view class="card-header">
        <view class="i-carbon-security text-lg text-primary-500" />
        <view class="card-title">
          隐私与安全
        </view>
      </view>
      ...
      <view class="divide-y divide-gray-100">
        <view class="setting-item">
          <view class="setting-label">
            <view class="i-carbon-fingerprint-recognition text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                生物识别
              </text>
          ...
          <view class="setting-control">
            <switch :checked="settings.biometric" :color="currentThemeColor" @change="toggleSetting('biometric')" />
          </view>
        </view>

        <view class="setting-item" @click="setAutoLock">
          <view class="setting-label">
            <view class="i-carbon-locked text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                自动锁屏
              </text>
        ...
        <view class="setting-item" @click="viewPrivacyPolicy">
          <view class="setting-label">
            <view class="i-carbon-document text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                隐私协议
              </text>
    ...
    <view class="settings-card">
      <view class="card-header">
        <view class="i-carbon-data-base text-lg text-primary-500" />
        <view class="card-title">
          存储与缓存
        </view>
      </view>
      ...
      <view class="divide-y divide-gray-100">
        <view class="setting-item" @click="viewStorageInfo">
          <view class="setting-label">
            <view class="i-carbon-data-volume text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                存储空间
              </text>
        ...
        <view class="setting-item" @click="clearCache">
          <view class="setting-label">
            <view class="i-carbon-clean text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                清除缓存
              </text>
        ...
        <view class="setting-item">
          <view class="setting-label">
            <view class="i-carbon-automatic text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                自动清理
              </text>
          ...
          <view class="setting-control">
            <switch :checked="settings.autoClean" :color="currentThemeColor" @change="toggleSetting('autoClean')" />
          </view>
        </view>
      </view>
    </view>
    ...
    <view class="settings-card">
      <view class="card-header">
        <view class="i-carbon-information text-lg text-primary-500" />
        <view class="card-title">
          关于与帮助
        </view>
      </view>
      ...
      <view class="divide-y divide-gray-100">
        <view class="setting-item" @click="checkUpdate">
          <view class="setting-label">
            <view class="i-carbon-application text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                版本信息
              </text>
        ...
        <view class="setting-item" @click="openHelpCenter">
          <view class="setting-label">
            <view class="i-carbon-help text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                帮助中心
              </text>
        ...
        <view class="setting-item" @click="submitFeedback">
          <view class="setting-label">
            <view class="i-carbon-chat text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                意见反馈
              </text>
        ...
        <view class="setting-item" @click="aboutUs">
          <view class="setting-label">
            <view class="i-carbon-favorite text-lg text-gray-400" />
            <view class="setting-info">
              <text class="setting-title">
                关于我们
              </text>
    ...
    <view class="mt-4">
      <wd-button
        class="w-full flex items-center justify-center rounded-lg  py-3 text-white font-medium transition-colors duration-200 active:bg-primary-600"
        hover-class="bg-primary-600" @click="resetSettings"
      >
        <view class="i-carbon-reset mr-2 text-lg" />
        重置设置
      </wd-button>
    </view>
  </view>
